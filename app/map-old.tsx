    ...
    return (
      <View 
        ...
        style={[
          ...
          { 
            position: 'absolute',
            left: spot.coordinate.longitude * 100, // Simple coordinate mapping
            top: spot.coordinate.latitude * 100 // Simple coordinate mapping
          }
        ]}
      >
        {/* Spot icon */}
          ...
          {filteredSpots.map((spot) => (
            <View key={spot.id} style={styles.listItem}>
              <View style={styles.listItemIcon}>
                <Text style={styles.listIconText}>{spot.emoji}</Text>
              </View>
