        ...
        <View style={styles.socialSection}>
          ...
          <View style={styles.enhancedGoalGrid}>
            ...
            <View style={{ marginTop: 16 }}>
              ...
              <TextInput
                style={[styles.textInput, styles.textArea, { width: '100%', minHeight: 60, marginLeft: -4, marginBottom: 8 }]} 
                placeholder=""
              ...
              <Text style={[styles.sectionTitle, { color: '#000', marginTop: 22, fontSize: 14, lineHeight: 22, marginRight: 12 }]}>What’s been frustrating or missing in your social life?</Text>
              <TextInput
